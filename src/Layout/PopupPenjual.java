...
/*
    @author llawl
 */
public class PopupPenjual extends javax.swing.JFrame {
    private DefaultTableModel tabmode;
    private static Connection conn = new connect().configDB();
    public Dashboard pen = null;
    public PopupPenjual() {
        initComponents();
        DataPen();
    }
    ...
    void DataPen(){
        ...
        try{
            String SQL = "SELECT * FROM Client where Nama like'%"+Cari+"%' and Status='Penjual' order by NIK asc";
    ...
    private void initComponents() {
        ...
        setMaximumSize(new java.awt.Dimension(1060, 649));
        setMinimumSize(new java.awt.Dimension(1060, 649));
        setPreferredSize(new java.awt.Dimension(1060, 649));
    ...
    private void tPenMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tPenMouseClicked
        ...
        pen.NamPen = tPen.getValueAt(row, 1).toString();
        pen.NikPen = tPen.getValueAt(row, 2).toString();
        pen.DataPenTerpilih();
        this.dispose();
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PopupPenjual().setVisible(true);
            }
        });
    }
